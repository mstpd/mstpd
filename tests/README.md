...
Tests require root privileges to create virtual bridges and veth pairs.
Run with sudo:
...
# Run specific suites
sudo ./tests/run_tests.sh T1 T2

# Run single suite with verbose output
sudo ./tests/run_tests.sh -v T1

# List available suites
sudo ./tests/run_tests.sh -l
```
